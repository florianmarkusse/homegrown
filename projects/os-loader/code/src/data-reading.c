...
#include "os-loader/efi/c-efi-base.h"                  // for ERROR, Handle
#include "os-loader/efi/c-efi-protocol-block-io.h"     // for BLOCK_IO_PROTOCOL...
#include "os-loader/efi/c-efi-protocol-file.h"         // for FileProtocol, FIL...
#include "os-loader/efi/c-efi-protocol-loaded-image.h" // for LOADED_IMAGE_PROT...
#include "os-loader/efi/c-efi-protocol-simple-file-system.h" // for SIMPLE_FILE_SYSTE...
#include "os-loader/efi/c-efi-protocol-simple-text-output.h"
#include "os-loader/efi/c-efi-system.h" // for OPEN_PROTOCOL_BY_...
