...
#define C_EFI_HARDWARE_ERROR_VARIABLE_GUID                                     \
    C_EFI_GUID(0x414E6BDD, 0xE47B, 0x47cc, 0xB2, 0x44, 0xBB, 0x61, 0x02, 0x0C, \
               0xF5, 0x16)
...
#define C_EFI_EVENT_GROUP_EXIT_BOOT_SERVICES                                   \
    C_EFI_GUID(0x27abf055, 0xb1b8, 0x4c26, 0x80, 0x48, 0x74, 0x8f, 0x37, 0xba, \
               0xa2, 0xdf)
#define C_EFI_EVENT_GROUP_VIRTUAL_ADDRESS_CHANGE                               \
    C_EFI_GUID(0x13fa7698, 0xc831, 0x49c7, 0x87, 0xea, 0x8f, 0x43, 0xfc, 0xc2, \
               0x51, 0x96)
#define C_EFI_EVENT_GROUP_MEMORY_MAP_CHANGE                                    \
    C_EFI_GUID(0x78bee926, 0x692f, 0x48fd, 0x9e, 0xdb, 0x1, 0x42, 0x2e, 0xf0,  \
               0xd7, 0xab)
#define C_EFI_EVENT_GROUP_READY_TO_BOOT                                        \
    C_EFI_GUID(0x7ce88fb3, 0x4bd7, 0x4679, 0x87, 0xa8, 0xa8, 0xd8, 0xde, 0xe5, \
               0x0d, 0x2b)
#define C_EFI_EVENT_GROUP_RESET_SYSTEM                                         \
    C_EFI_GUID(0x62da6a56, 0x13fb, 0x485a, 0xa8, 0xda, 0xa3, 0xdd, 0x79, 0x12, \
               0xcb, 0x6b)
...
#define C_EFI_SMBIOS_TABLE_GUID                                                \
    C_EFI_GUID(0xeb9d2d31, 0x2d88, 0x11d3, 0x9a, 0x16, 0x00, 0x90, 0x27, 0x3f, \
               0xc1, 0x4d)
#define C_EFI_SMBIOS3_TABLE_GUID                                               \
    C_EFI_GUID(0xf2fd1544, 0x9794, 0x4a2c, 0x99, 0x2e, 0xe5, 0xbb, 0xcf, 0x20, \
               0xe3, 0x94)
...
typedef struct CEfiRuntimeServices {
    ...
    CEfiStatus(CEFICALL *get_time)(CEfiTime *time,
    ...
    CEfiStatus(CEFICALL *set_virtual_address_map)(
        ...
        CEfiU32 descriptor_version, CEfiMemoryDescriptor *virtual_map);
    ...
    CEfiStatus(CEFICALL *set_variable)(CEfiChar16 *variable_name,
                                       CEfiGuid *vendor_guid,
                                       CEfiU32 attributes, CEfiUSize data_size,
                                       void *data);

    CEfiStatus(CEFICALL *get_next_high_mono_count)(CEfiU32 *high_count);
    ...
    CEfiStatus(CEFICALL *query_capsule_capabilities)(
        CEfiCapsuleHeader **capsule_header_array, CEfiUSize capsule_count,
        CEfiU64 *maximum_capsule_size, CEfiResetType *reset_type);

    CEfiStatus(CEFICALL *query_variable_info)(
        CEfiU32 attributes, CEfiU64 *maximum_variable_storage_size,
...
typedef struct CEfiBootServices {
    ...
    CEfiTpl(CEFICALL *raise_tpl)(CEfiTpl new_tpl);
    void(CEFICALL *restore_tpl)(CEfiTpl old_tpl);
    ...
    CEfiStatus(CEFICALL *create_event)(CEfiU32 type, CEfiTpl notify_tpl,
    ...
    CEfiStatus(CEFICALL *install_protocol_interface)(
        ...
        CEfiInterfaceType interface_type, void *interface);
    CEfiStatus(CEFICALL *reinstall_protocol_interface)(CEfiHandle handle,
                                                       CEfiGuid *protocol,
                                                       void *old_interface,
                                                       void *new_interface);
    CEfiStatus(CEFICALL *uninstall_protocol_interface)(CEfiHandle handle,
                                                       CEfiGuid *protocol,
                                                       void *interface);
    CEfiStatus(CEFICALL *handle_protocol)(CEfiHandle handle, CEfiGuid *protocol,
                                          void **interface);
    void *reserved;
    CEfiStatus(CEFICALL *register_protocol_notify)(CEfiGuid *protocol,
                                                   CEfiEvent event,
                                                   void **registration);
    ...
    CEfiStatus(CEFICALL *get_next_monotonic_count)(CEfiU64 *count);
    ...
    CEfiStatus(CEFICALL *open_protocol)(CEfiHandle handle, CEfiGuid *protocol,
                                        void **interface,
                                        CEfiHandle agent_handle,
                                        CEfiHandle controller_handle,
                                        CEfiU32 attributes);
    CEfiStatus(CEFICALL *close_protocol)(CEfiHandle handle, CEfiGuid *protocol,
                                         CEfiHandle agent_handle,
                                         CEfiHandle controller_handle);
    ...
    void(CEFICALL *set_mem)(void *buffer, CEfiUSize size, CEfiU8 value);

    /* 2.0+ */

    CEfiStatus(CEFICALL *create_event_ex)(CEfiU32 type, CEfiTpl notify_tpl,
                                          CEfiEventNotify notify_function,
                                          void *notify_context,
