...
DescriptorTableRegister *prepNewGDT(PhysicalBasePage zeroPages[3]) {
    ...
    *GDT = (GDTTable){
        ...
        .tssDescriptor = {
            ...
            .base_15_0 = (U64)(zeroPages[0].data) & 0xFFFF,
            .base_23_16 = ((U64)(zeroPages[0].data) >> 16) & 0xFF,
            .type = 9, // 0b1001 = 64 bit TSS (available)
            .p_flag = 1,
            .base_31_24 = ((U64)(zeroPages[0].data) >> 24) & 0xFF,
            .base_63_32 = ((U64)(zeroPages[0].data) >> 32) & 0xFFFFFFFF,
        }};
