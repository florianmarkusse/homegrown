...
#include "efi/efi/c-efi-base.h"                       // for SUCCESS
#include "efi/efi/c-efi-protocol-simple-text-input.h" // for InputKey
#include "efi/efi/c-efi-protocol-simple-text-output.h" // for SimpleTextOutputP...
#include "efi/efi/c-efi-system.h"                      // for ResetType
