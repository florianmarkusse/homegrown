...
#include "efi/efi/c-efi-protocol-graphics-output.h"    // for GRAPHICS_OUTP...
#include "efi/efi/c-efi-protocol-simple-text-output.h" // for SimpleTextOut...
#include "efi/efi/c-efi-system.h"                      // for SystemTable
#include "efi/gdt.h"                                   // for enableNewGDT
#include "efi/globals.h"                               // for globals
#include "efi/memory/boot-functions.h"                 // for mapMemoryAt
