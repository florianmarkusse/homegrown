...
__attribute__((section("kernel-start"))) int kernelmain() {
    ...
    FLUSH_AFTER {
        LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
    ...
    FLUSH_AFTER {
        LOG(STRING("TESTTESTTESTTESTTESTTESTTEST\t3\t22\t111\t\thjkhkjhjk"));
    }

    FLUSH_AFTER { LOG(STRING("DDDDDDDDDDDDD\tDDDDDDDDD\tDDDDDDDD\n")); }
    ...
    FLUSH_AFTER {
        LOG(STRING("TESTTESTTESTTESTTESTTESTTEST\t3\t22\t111\t\thjkhkjhjk"));
        LOG(STRING("DDDDDDDDDDDDD\tDDDDDDDDD\tDDDDDDDD\thjgkd\t\tgk\thkj\t\t"));
        LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n"));
    }

    FLUSH_AFTER {
        LOG(STRING("BBBBBBBBBBBBBBBBB\\\\BBBBBBBBBBBBBB\\n"));
        ...
        LOG(STRING("DDDDDDDDDDDDD\tDDDDDDDDD\tDDDDDDDD\n"));
        LOG(STRING("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\n"));
        LOG(STRING("GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG\n"));
        LOG(STRING("HHHHHHHHHHHHHHHHH\tHHHHHHHHHHHHHH\n"));
        ...
        LOG(STRING("LLLLLLLLLLLLLLLLLLLLL\tLLLLLLLLLL\n"));
        ...
        LOG(STRING("QQQQQQQQQQ\t\t\tQQQQQQQQQQQQQQQQQQQQQ\n"));
        ...
        LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n"));
        LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n"));
        LOG(STRING("AAAAAAAAAAAAAAA\tAAAAAAAAAAAAAAAA\n"));
        LOG(STRING("AAAAAAAAAAAAAAAA\tAAAAAAAAAAAAAAA\n"));
        LOG(STRING("AAAAAAAAAAAAAAAAA\tAAAAAAAAAAAAAA\n"));
        LOG(STRING("\n"));
        LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n"));
        LOG(STRING("AAAAAAAAAAAAAAAAAA\tAAAAAAAAAAAAA\n"));
        LOG(STRING("\t\tAAAAAAAAAAAAAAAAAAA\tAAAAAAAAAAAA\n"));
        LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n"));
        LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\t\t"));
    }
