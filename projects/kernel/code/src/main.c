...
__attribute__((section("kernel-start"))) int kernelmain() {
    ...
    FLUSH_AFTER { LOG(STRING_LEN(page, 5)); }

    mapVirtualRegion(virtualAddress, memoryForAddresses[0], BASE_PAGE, 0);

    PhysicalBasePage *new = (PhysicalBasePage *)virtualAddress;
    ...
    FLUSH_AFTER { LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n")); }
    FLUSH_AFTER { LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n")); }
    FLUSH_AFTER { LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n")); }
    FLUSH_AFTER { LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n")); }
    FLUSH_AFTER { LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n")); }
    ...
    FLUSH_AFTER { LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n")); }
    FLUSH_AFTER { LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n")); }
    FLUSH_AFTER { LOG(STRING("BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB\n")); }
    FLUSH_AFTER { LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n")); }
    FLUSH_AFTER { LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n")); }
    FLUSH_AFTER { LOG(STRING("BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB\n")); }
    FLUSH_AFTER { LOG(STRING("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n")); }
