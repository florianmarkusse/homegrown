...
func CreateUefiImage(buildMode string) {
	...
	if err := argument.ExecCommand(copyEfiCommand); err != nil {
	...
	if err := argument.ExecCommand(copyKernelCommand); err != nil {
	...
	if err := argument.ExecCommand(createTestImageCommand); err != nil {
