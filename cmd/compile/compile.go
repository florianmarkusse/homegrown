...
func usage() {
	...
	fmt.Printf("  %s --%s=%s --%s %s,%s --%s -%s\n", filepath.Base(os.Args[0]),
		buildmode.BUILD_MODE_LONG_FLAG, buildmode.PossibleBuildModes[1], project.PROJECTS_LONG_FLAG, project.KERNEL, project.EFI, BUILD_TESTS_LONG_FLAG, RUN_TESTS_SHORT_FLAG)
	fmt.Printf("\n")
}
