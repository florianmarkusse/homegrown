#ifndef C_EFI_PROTOCOL_SIMPLE_TEXT_OUTPUT_H
#define C_EFI_PROTOCOL_SIMPLE_TEXT_OUTPUT_H
...
typedef struct CEfiSimpleTextOutputProtocol {
    ...
    CEfiStatus(CEFICALL *query_mode)(CEfiSimpleTextOutputProtocol *this_,
                                     CEfiUSize mode_number, CEfiUSize *columns,
                                     CEfiUSize *rows);
    ...
    CEfiStatus(CEFICALL *set_cursor_position)(
        CEfiSimpleTextOutputProtocol *this_, CEfiUSize column, CEfiUSize row);
